                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapp">
                            <h4 class="header-title"><?php echo e(__('Support Info Leftbar Items')); ?>  </h4>
...
<?php endif; ?>
            ...
            <div class="col-lg-4 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('Topbar Social Icons')); ?></h4>
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.update.support.info')); ?>" id="support_info_item_edit_modal_form"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_icon" class="d-block"><?php echo e(__('Support Info Icon')); ?></label>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/intoday/@core/resources/views/backend/pages/topbar-settings.blade.php ENDPATH**/ ?>