<div class="main-img-box">
    ...
    <?php else: ?>
        <div class="img-bg v-02" <?php echo render_background_image_markup_by_attachment_id($blog_post->image,'','large'); ?>></div>
    <?php endif; ?>

</div>

<?php /**PATH D:\laragon\www\katerio\@core\resources\views/frontend/pages/blog-single-two-portions/image-and-gallery.blade.php ENDPATH**/ ?>