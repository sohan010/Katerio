                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="sidebar_layout" class="form-control">
                                        ...
                                        <option value="blog"><?php echo e(__('Blog Widget Area')); ?></option>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\in-today\@core\resources\views/backend/pages/page/new.blade.php ENDPATH**/ ?>