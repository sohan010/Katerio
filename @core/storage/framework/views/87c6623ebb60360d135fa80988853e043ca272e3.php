        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="chart-wrapper margin-top-40">
                            <h2 class="chart-title small text-center"><?php echo e(__("As Viewers Country Last 30 Days")); ?></h2>
                            <div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/intoday/@core/resources/views/backend/admin-home.blade.php ENDPATH**/ ?>