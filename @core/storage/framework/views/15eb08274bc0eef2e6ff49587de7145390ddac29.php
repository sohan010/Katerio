            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="login-form-wrapper contact-form">
                        <h2 class="text-center title margin-bottom-30"><?php echo e(__('Register New Account')); ?></h2>
                        ...
                        <form action="<?php echo e(route('user.register')); ?>" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                            ...
                            <div class="form-group">
                                <select id="country" class="form-control" name="country" style="height:52px;">
                            ...
                            <div class="form-group btn-wrapper">
                                <button class="btn-default btn-block" id="register" type="submit"><?php echo e(__('Register')); ?></button>
                            </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/intoday/@core/resources/views/frontend/user/register.blade.php ENDPATH**/ ?>