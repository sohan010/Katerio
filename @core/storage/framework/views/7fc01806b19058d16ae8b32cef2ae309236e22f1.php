                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 page_class d-none">
                                ...
                                <select name="page_class" class="form-control">
                                    ...
                                    <option value="container-two"<?php if($page_post->page_class == 'container-two'): ?> selected <?php endif; ?>><?php echo e(__('Container Two')); ?></option>
                                </select>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/intoday/@core/resources/views/backend/pages/page/edit.blade.php ENDPATH**/ ?>