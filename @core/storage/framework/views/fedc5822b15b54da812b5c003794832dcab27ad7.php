...
<?php $__env->startSection('site-title'); ?>
    <?php echo e($author_info->name); ?> : <?php echo e(__('Blogs')); ?>
                    ...
                    <div class="author-profile-flex">
                        ...
                        <div class="profile-contents">
                            <div class="author-profile-top">
                                <h3 class="profile-title"> <a href="#0"> <?php echo e($author_info->name); ?> </a> </h3>
                                <div class="profile-span"> <?php echo e($author_info->designation); ?> </div>

                                <p class="common-para"> <?php echo $author_info->description; ?></p>
                            </div>
                            <div class="author-profile-bottom">
                                <ul class="common-socials">
                                    <li>
                                        <a class="facebook" href="<?php echo e($author_info->facebook_url); ?>"> <i class="lab la-facebook-f"></i> </a>
                                    </li>
                                    <li>
                                        <a class="twitter" href="<?php echo e($author_info->twitter_url); ?>"> <i class="lab la-twitter"></i> </a>
                                    </li>
                                    <li>
                                        <a class="instagram" href="<?php echo e($author_info->instagram_url); ?>"> <i class="lab la-instagram"></i> </a>
                                    </li>
                                    <li>
                                        <a class="linkedin" href="<?php echo e($author_info->linkedin_url); ?>"> <i class="lab la-linkedin-in"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
          ...
          <div class="col-md-6">
              <div class="alert-area padding-bottom-100">
                      <div class="alert alert-warning">
                          <?php echo __('No post found related to').' '. '<strong> '.$author_info->name.' </strong>'; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/intoday/@core/resources/views/frontend/pages/blog/author-profile.blade.php ENDPATH**/ ?>