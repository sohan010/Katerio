...
<?php endif; ?>
                                                        <?php else: ?>
                                                            <span class="ale rt alert-warning text-capitalize"><?php echo e(__('super admin has all access')); ?></span>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/intoday/@core/resources/views/backend/admin-role-manage/role/index.blade.php ENDPATH**/ ?>