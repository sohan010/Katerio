            ...
            <div class="blog-grid-style-03 small-02">
                ...
                <div class="content">
                    ...
                    <h4 class="title font-size-24 font-weight-600">
                        <a href="<?php echo e(route('frontend.blog.single',$data->slug)); ?>"><?php echo e(Str::words($data->title,15) ?? ''); ?></a>
                    </h4>
                </div>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\katerio\@core\resources\views/frontend/pages/blog-single-two-portions/related-blogs.blade.php ENDPATH**/ ?>