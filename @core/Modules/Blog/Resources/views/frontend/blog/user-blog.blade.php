                        ...
                        <div class="author-profile-flex">
                            ...
                            <div class="profile-contents">
                                <div class="author-profile-top">
                                    <h3 class="profile-title">  {{$user_info->name}} </h3>
                                    <div class="profile-span"> {{$user_info->designation}} </div>

                                    <p class="common-para"> {!! $user_info->description !!}</p>
                                </div>
                                <div class="author-profile-bottom">
                                    <ul class="common-socials">
                                        <li>
                                            <a class="facebook" href="{{$user_info->facebook_url}}"> <i class="lab la-facebook-f"></i> </a>
                                        </li>
                                        <li>
                                            <a class="twitter" href="{{$user_info->twitter_url}}"> <i class="lab la-twitter"></i> </a>
                                        </li>
                                        <li>
                                            <a class="instagram" href="{{$user_info->instagram_url}}"> <i class="lab la-instagram"></i> </a>
                                        </li>
                                        <li>
                                            <a class="linkedin" href="{{$user_info->linkedin_url}}"> <i class="lab la-linkedin-in"></i> </a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="alert-area padding-bottom-100">
                        <div class="alert alert-warning">
                            {!! __('No post found related to').' '. '<strong> '.$user_info->name.' </strong>'!!}
                        </div>
                    </div>
                </div>
