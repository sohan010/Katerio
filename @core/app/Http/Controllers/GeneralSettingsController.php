...
class GeneralSettingsController extends Controller
{
    ...
    public function update_license_settings(Request $request)
    {
        ...
        $response = Http::post('https://bytesed.com/api/license/new', [
            ...
            'site_url' => url('/'),
            'item_unique_key' => 'CwpkpXDQVYTKudWyiM9q8CUgsMMgTpNk',
        ]);
        ...
        return redirect()->back()->with(['msg' => 'there is a problem with connect xgenious server please contact support', 'type' => 'danger']);
    }
