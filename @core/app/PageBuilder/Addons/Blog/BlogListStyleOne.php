...
class BlogListStyleOne extends PageBuilderBase
{
    ...
    public function frontend_render()
    {
        ...
        $video_and_image = '';
            ...
            $video_and_image .= '<a href="' . $video_url . '" class="play-icon videos-play-global videos-play-medium" style="color: ' . $play_icon_color . '">
 ...
 $blog_markup .= <<<HTML
    <div class="{$columns}">
        <div class="single-trendy margin-top-30">
            <div class="trendy-thumb video-parent-global">
                 {$image}
            ...
            <div class="trendy-contents">
                ...
                <h2 class="trendy-title"> <a href="{$route}"> {$title} </a> </h2>
            </div>
        </div>
    </div>
HTML;
 ...
 return <<<HTML
 <div class="blog-two-wrapper res-padding-reverse" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
    <div class="row">
        {$blog_markup}
        {$pagination_markup}
    </div>
