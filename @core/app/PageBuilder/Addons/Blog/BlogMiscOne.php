        ...
        <div class="container custom-container-01">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div class="ads-banner-area-wrapper leaderboard" data-padding-top="0" data-padding-bottom="$padding_bottom">
                        <div class="container custom-container-01">
                            <div class="rwo">
                                <div class="col-lg-12">
...
private function LeftVideos($left_blogs,$left_items){
 ...
 <div class="blog-grid-style-03 large slick-item">
    <div class="img-box video-blog">
        <div class="background-img" {$bg_image} data-height="590"></div>
