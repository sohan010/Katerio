...
class VideoAreaStyleOne extends PageBuilderBase
{
    ...
    public function frontend_render()
    {
        ...
        foreach ($blogs as  $item){
            ...
            $video_play_btn = '';
            if (!empty($video_url)){
                $video_play_btn ='<a href="'.$video_url.'"class="videos-play v-01"> <i class="las la-play" style="color: '.$play_icon_color.' !important;"></i></a></div>';
            }
...
<section class="video-area"data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}">
    ...
    <div class="video-slider slider-nav-style">
       {$video_markup}
    </div>
</section>
HTML;
